...
public class AppTest {
    ...
    private static final String PLAYER_LUCA_GOOSER = "{ \"name\": \"Luca\", \"nickname\": \"gooser\"}";
    private static final String PLAYER_PAOLO_GOOSER = "{ \"name\": \"Paolo\", \"nickname\": \"gooser\"}";
